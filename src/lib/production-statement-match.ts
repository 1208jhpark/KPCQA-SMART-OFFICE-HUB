...
/** 사무문구류(OFFICE_SUPPLIES) 품목 매칭 기본값 — 드림디포 26년 1~8월 거래명세서 축약명 보강 */
export const DEFAULT_PLATE_ITEM_ALIASES_OFFICE: PlateItemAliasMap = {
  // —— 티슈류 ——
  각티슈: ['티슈', '로션티슈', '명품로션티슈', '잘풀리는집', '미용티슈'],
  물티슈: ['물티슈', '손소독티슈'],
  미용티슈: ['미용티슈', '티슈', '각티슈'],
  손소독티슈: ['손소독', '물티슈'],
  // —— 건전지 ——
  건전지: ['건전지', '알카라인', '벡셀', '듀라셀', '벡셀건전지', '듀라셀건전지'],
  벡셀건전지: ['벡셀', '건전지', '알카라인'],
  듀라셀건전지: ['듀라셀', '건전지'],
  // —— 펜·리필 ——
  다색리필: ['다색리필', '다색 리필', '리필', '프릭션다색리필', '프릭션리필'],
  프릭션다색리필: ['프릭션', '다색리필', '리필'],
  프릭션리필: ['프릭션', '리필', '다색리필'],
  프릭션3색펜: ['프릭션', '3색', '3색프릭션펜', '3색볼펜'],
  '3색프릭션펜': ['프릭션', '3색', '프릭션3색펜'],
  프릭션4색: ['프릭션', '4색'],
  '3색볼펜': ['3색', '볼펜', '프릭션'],
  제트스트림펜: ['제트스트림볼펜', '제트스트림', '캡식제트스트림펜', '캡제트스트림펜'],
  제트스트림: ['제트스트림펜', '제트스트림볼펜'],
  캡식제트스트림펜: ['제트스트림', '캡제트스트림펜'],
  캡제트스트림펜: ['제트스트림', '캡식제트스트림펜'],
  제트스트림라이트터치펜: ['제트스트림라이트터치', '라이트터치', '제트스트림'],
  FX153볼펜: ['FX153', '볼펜'],
  트리피스볼펜: ['트리피스', '볼펜'],
  스피디볼: ['스피디', '볼펜'],
  프러스펜: ['프러스', '펜'],
  슈퍼그립: ['슈퍼그립', '볼펜'],
  네임펜: ['네임펜', '네임펜T', '네임펜t', '네임펜x'],
  네임펜T: ['네임펜'],
  네임펜t: ['네임펜'],
  네임펜x: ['네임펜'],
  목재샤프: ['샤프', '목재'],
  ...
  지우개: ['지우개'],
  // —— 형광·수정 ——
  형광펜: ['형광펜', '5색형광펜', '고체형광펜', '저스트클릭형광펜', '형광색연필'],
  '5색형광펜': ['형광펜', '5색'],
  고체형광펜: ['형광펜', '고체'],
  저스트클릭형광펜: ['형광펜', '저스트클릭'],
  형광색연필: ['형광', '색연필'],
  ...
  견출지: ['견출', '견출테이프'],
  // —— 테이프·풀 ——
  다용도테이프: ['다용도테이프', '스카치', '매직테이프', '다용도테이프리필'],
  다용도테이프리필: ['다용도테이프', '리필', '스카치'],
  매직테이프: ['매직테이프', '스카치', '다용도테이프'],
  투명테이프: ['투명테이프', '테이프'],
  양면테이프: ['양면테이프', '양면'],
  롱라인테이프: ['롱라인', '테이프'],
  풀테이프: ['풀테이프', '노트식풀테이프리필'],
  ...
  리무버: ['리무버'],
  // —— 포스트잇·메모 ——
  포스트잇: ['포스트잇', '알뜰팩', '포스트잇알뜰팩', '653', '스티키'],
  '포스트잇 알뜰팩': ['포스트잇', '알뜰팩'],
  포스트잇알뜰팩: ['포스트잇', '알뜰팩'],
  '포스트잇 653-2': ['포스트잇', '653'],
  '포스트잇 653-4': ['포스트잇', '653'],
  반투명스티키노트: ['스티키', '포스트잇', '메모'],
  인덱스5색메모지: ['인덱스', '메모지', '5색'],
  인덱스8색: ['인덱스', '8색', '인덱스8색메모지'],
  인덱스8색메모지: ['인덱스', '8색', '메모지'],
  프로패드: ['프로패드', '노트', '절취노트'],
  절취노트: ['절취', '노트'],
  // —— 홀더·화일·박스 ——
  고투명홀더: ['고투명홀더', '투명홀더', '홀더', '4포켓홀더'],
  투명홀더: ['투명홀더', '고투명홀더', '홀더'],
  '4포켓홀더': ['홀더', '포켓', '투명홀더'],
  정부화일: ['정부화일', 'PP정부화일', 'pp정부화일', '대용량PP정부화일'],
  PP정부화일: ['정부화일', 'PP'],
  pp정부화일: ['정부화일', 'PP'],
  대용량PP정부화일: ['정부화일', '대용량', 'PP'],
  pp스프링화일: ['스프링화일', '화일'],
  레버클립화일: ['레버클립', '화일'],
  라운드쫄대화일: ['쫄대', '화일'],
  합지바인다: ['바인더', '합지', '바인다'],
  뱅커스박스: ['뱅커스박스', '보관상자'],
  문서보관상자: ['문서보관상자', '보관상자', '뱅커스박스'],
  클립보드: ['클립보드'],
  메모홀더: ['메모홀더', '홀더'],
  // —— 용지 ——
  복사용지: ['복사용지', '복사지', '복사'],
  복사지: ['복사용지', '복사', '복사용지'],
  팬시페이퍼: ['팬시페이퍼', '색지', '메탈컬렉션', '메탈컬렉션색지'],
  색지: ['색지', '팬시페이퍼', '메탈컬렉션'],
  메탈컬렉션: ['메탈컬렉션', '색지', '메탈컬렉션색지'],
  메탈컬렉션색지: ['메탈컬렉션', '색지'],
  상장용지: ['상장용지', '상장'],
  손코팅필름: ['코팅', '필름'],
  // —— 봉투·컵·생활 ——
  ...
  페브리즈: ['페브리즈', '페브리즈에어'],
  페브리즈에어: ['페브리즈', '에어'],
  주방세제: ['주방세제', '세제', '프릴베이킹소다'],
  프릴베이킹소다: ['프릴', '베이킹소다', '주방세제'],
  수세미: ['수세미'],
  보틀크리너: ['보틀크리너', '보틀크리너리필'],
  보틀크리너리필: ['보틀크리너', '리필'],
  접시: ['접시'],
