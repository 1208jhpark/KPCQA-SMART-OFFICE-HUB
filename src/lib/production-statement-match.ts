...
/** 사무문구류(OFFICE_SUPPLIES) 품목 매칭 기본값 — 드림디포 25~26년 거래명세서 축약명 보강 */
/** 사무문구류(OFFICE_SUPPLIES) 품목 매칭 기본값 — 드림디포 25~26년 거래명세서 축약명 보강 */
export const DEFAULT_PLATE_ITEM_ALIASES_OFFICE: PlateItemAliasMap = {
  "4색볼펜": ["필기구"],
  가위: ["사무용가위", "다용도가위", "블랙코팅가위", "코팅"],
  각티슈: ["티슈", "로션티슈", "명품로션티슈", "잘풀리는집", "미용티슈", "미니각티슈", "콤비각티슈", "디럭스미니티슈", "명품티슈", "순수소프트티슈", "순수소프티티슈", "미용티슈 미니"],
  개별멀티탭: ["멀티탭", "개별멀티콘센트", "콘센트"],
  건전지: ["알카라인", "벡셀", "듀라셀", "벡셀건전지", "듀라셀건전지", "도시바건전지", "수은전지", "전지"],
  검인천공기: ["천공기", "펀치"],
  견출테이프: ["견출", "견출지"],
  경조사봉투: [],
  고투명홀더: ["투명홀더", "홀더", "4포켓홀더", "반투명홀더", "강력자석홀더", "대용량클리어홀더", "10포켓화일", "두꺼운클리어화일", "포켓", "클리어", "자석"],
  네임펜: ["네임펜T", "네임펜t", "네임펜x", "저스트클릭네임펜", "네임펜세트"],
  다색리필: ["다색 리필", "리필", "프릭션다색리필", "프릭션리필", "제트스트림다색리필", "스타일핏리필", "프릭션볼슬림리필", "프릭션볼리필", "스타일핏"],
  다용도테이프: ["스카치", "매직테이프", "다용도테이프리필", "포장용테이프", "박스테이프", "매직테이프리필", "강력폼양면테이프", "박스테이프디스펜서", "테이프", "리필", "매직", "유성"],
  더블크립: ["더블크립", "클립"],
  듀얼머니터받침대: ["모니터", "받침대"],
  딱풀: ["풀", "조은풀"],
  라벨지: ["라벨"],
  라운드쫄대화일: ["쫄대", "화일", "쫄대화일", "대용량쫄대화일", "레일쫄대화일"],
  레버클립화일: ["레버클립", "화일"],
  레이저포인터: ["레이저", "포인터", "그린레이저포인터", "프리젠터", "무선프리젠터"],
  롱라인테이프: ["롱라인", "테이프"],
  리무버: ["리무버"],
  마이룸시스템서랍장: [],
  메모리카드: ["메모리카드", "SD", "microSD"],
  메모홀더: ["메모홀더", "홀더"],
  명함케이스: ["명함", "명함첩"],
  모서리보호대: ["모서리", "보호대"],
  목재샤프: ["샤프", "목재"],
  무선마우스: ["마우스", "무선", "무소음마우스", "무소음"],
  무소음가각캐리어: ["캐리어"],
  문서세단기: ["세단기", "파쇄"],
  물티슈: ["손소독티슈", "마이비데물티슈", "바디샤워 물티슈", "베비랑물티슈", "새싹이물티슈", "손소독", "바디샤워"],
  미니맥시: [],
  바스켓: [],
  방안자: ["방안자", "자"],
  백봉투: [],
  뱅커스박스: ["보관상자", "문서보관상자", "보관용박스", "화일박스", "박스"],
  번호자물쇠: [],
  보틀크리너: ["보틀크리너리필", "리필"],
  복사용지: ["복사지", "복사"],
  볼펜: ["필기구"],
  북엔드: ["북엔드", "책받침"],
  블루투스키보드: ["키보드", "블루투스"],
  비닐안전봉투: ["비닐안전봉투", "안전봉투", "비닐봉투"],
  비말마스크: ["마스크", "비말"],
  사각행거: ["행거"],
  사라사펜: ["사라사", "볼펜", "사라사3+S", "사라사4색"],
  사무문구류: ["문구", "사무용품"],
  상장용지: ["상장용지", "상장"],
  상장케이스: ["상장", "케이스", "단면쇼케이스", "양면쇼케이스", "쇼케이스"],
  생수: ["아이시스"],
  샤프: ["필기구"],
  샤프심: ["샤프심", "샤프"],
  세제: [],
  소음방지범퍼: ["범퍼", "소음"],
  소프트보드: ["보드", "패드", "데스크장패드", "블랙스탠패드", "와이드데스크패드", "폼보드"],
  손목받침대: [],
  손코팅필름: ["코팅", "필름"],
  쇠자: ["가위", "자", "칼"],
  수세미: ["그물망수세미"],
  ...
  슈퍼그립: ["슈퍼그립", "볼펜"],
  스탠드: ["스탠드"],
  스테플러: ["스테프러35", "35", "날크립기", "날크립나이스러", "점보날크립", "점보실버날크립", "33호침", "33호", "침", "날크립"],
  스텝옷걸이: [],
  스프링노트: ["노트"],
  스피디볼: ["스피디", "볼펜"],
  썬스타: ["썬스타", "스테이플러"],
  ...
  양면테이프: ["양면테이프", "양면"],
  양용드라이버: ["드라이버"],
  어댑터: ["랜어댑터", "LAN어댑터", "다이렉트랜케이블", "모니터케이블", "미러링케이블", "CtoC케이블", "케이블", "USB"],
  에프엑스제타볼펜: ["필기구"],
  엔디자석: ["자석"],
  연필: ["연필"],
  열제본표지: ["제본", "표지"],
  ...
  유성매직: ["매직", "유성"],
  육각렌치: ["육각", "렌치"],
  인덱스5색메모지: ["인덱스", "메모지", "5색", "8색", "인덱스8색메모지", "인덱스8색"],
  인주: ["만년인주", "원형인주"],
  자석멀티보드: ["자석", "보드", "화이트보드"],
  자석제침기: ["제침기", "스테플러"],
  저소음미니포장테이프: ["포장테이프", "저소음"],
  절취노트: ["절취", "노트"],
  점보실버크립: ["클립", "실버"],
  접시: ["접시"],
  정밀드라이버세트: ["드라이버", "정밀"],
  정부화일: ["PP정부화일", "pp정부화일", "대용량PP정부화일", "대용량정부화일", "PP", "대용량"],
  제록스토너: ["제록스", "토너", "제록스 DPCP315d", "DPCP315d", "카트리지"],
  제트스트림펜: ["제트스트림", "제트스트림볼펜", "캡식제트스트림펜", "캡제트스트림펜", "캡식제트스트림", "3색제트스트림펜", "제트스트림라이트터치", "제트스트림라이트터치펜", "라이트터치", "제트스트림다색리필", "제트스트림심"],
  종이컵: ["일반종이컵", "온스컵", "컵", "16온스컵", "12온스컵", "10온스컵", "13온스컵", "13온스", "10온스", "16온스", "12온스종이컵", "16온스종이컵", "온스", "12온스"],
  주방세제: ["세제", "프릴베이킹소다", "프릴", "베이킹소다"],
  줄자: ["줄자"],
  줌라이트: [],
  지우개: ["아인지우개", "필기구"],
  책꽂이: ["4단책꽂이"],
  ...
  큐티자석: ["자석"],
  클립보드: ["메탈클립보드", "불투명클립보드"],
  토너: ["카트리지", "잉크카트리지", "hp토너", "제록스토너", "HP", "제록스"],
  투명테이프: ["투명테이프", "테이프"],
  트리피스볼펜: ["트리피스", "볼펜"],
  팝업디스펜서: ["디스펜서", "팝업"],
  팬시페이퍼: ["색지", "메탈컬렉션", "메탈컬렉션색지"],
  페브리즈: ["페브리즈에어", "에어"],
  펜꽂이: ["우든펜꽂이", "연필꽂이", "필기구"],
  포스트잇: ["알뜰팩", "포스트잇알뜰팩", "653", "스티키", "스티키알뜰팩", "팝업포스트잇", "포스트잇팝업알뜰팩", "전화메모포스트잇", "플래너스티키노트", "포스트잇 플래그", "전화메모지", "포스트잇 알뜰팩", "업다운인덱스플래그", "혼합형메모지", "반투명스티키노트", "포스트잇 653-2", "포스트잇 653-4", "플래그", "메모", "노트"],
  포크: [],
  풀테이프: ["노트식풀테이프리필", "풀테이프리필", "리필", "테이프", "스카치"],
  프러스펜: ["프러스", "펜", "프러스펜s"],
  프로패드: ["프로패드", "노트", "절취노트"],
  프릭션3색펜: ["프릭션", "3색", "3색프릭션펜", "3색볼펜", "프릭션3색", "프릭션3색슬림펜", "프릭션볼슬림3색펜", "프릭션4색", "프릭션4색펜", "프릭션다색리필", "프릭션리필", "프릭션볼리필", "프릭션볼슬림리필", "프릭션형광펜", "4색", "볼펜", "리필", "다색리필", "형광펜", "형광"],
  합지바인다: ["바인더", "합지", "바인다", "3공바인다", "투톤클리어바인다"],
  핫팩: [],
  허브: ["스위칭", "멀티허브", "7포트허브", "7포터허브", "멀티7포트허브", "커넥트4포트허브", "스위칭허브", "5포트기가스위칭허브", "기가"],
  형광펜: ["5색형광펜", "고체형광펜", "저스트클릭형광펜", "형광색연필", "6색형광펜", "3색형광펜", "프릭션형광펜", "5색", "6색", "3색", "고체", "형광", "저스트클릭", "색연필"],
  화상카메라: ["카메라", "웹캠", "화상"],
  휴지통: ["실크링휴지통"],
  FX153볼펜: ["FX153", "볼펜"],
  hp토너: ["HP", "토너", "hp", "잉크카트리지", "카트리지"],
  LED라이트: ["LED", "라이트"],
  pp스프링화일: ["스프링화일", "화일"],
};
